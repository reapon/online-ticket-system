...
namespace OnlineTicketSystem.Controllers
{
    public class SuperAdminController : Controller
    {
        ...
        public SuperAdminController(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> CompanyAdminList()
        {
            var companyAdmin = await userManager.GetUsersInRoleAsync("Company Admin");
            return View(companyAdmin);
        }

        [HttpPost]
        public async Task<JsonResult> DisableCompany(string userid)
        {
        ...
        [HttpPost]
        public async Task<JsonResult> EnableCompany(string userid)
        {
            var user = await userManager.FindByIdAsync(userid);
